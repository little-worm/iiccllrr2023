...
data_size = 300; kClusters = 60; zeta = 0.2; noise_mean = 40; noise_var = 40; label=0
epsilon = 1000; eta = 1; UOTRWBIter = 10; testtimes = 1; gamma_list = array([1,4,16,64,256,1024])
...
foldDir = cfd + 'results_numerical_instability/' + foldName
my_mkdir(foldDir)
