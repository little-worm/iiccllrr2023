...
cfd = os.path.dirname(__file__)
print("cfd = ",cfd)
foldName = 'ModelNet_' + '_' + str(data_size)+ '_'+ str(kClusters)+ '_'+ str(epsilon) +'_outlier_'+ str(zeta)+ '_' + str(noise_mean) + '_' + str(noise_var) + '_tt'+ str(testtimes) + '_' + str(timeStamp)
